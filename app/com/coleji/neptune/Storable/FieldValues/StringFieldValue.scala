...
import com.coleji.neptune.Storable.{GetSQLLiteralForPrepared, GetSQLLiteralPair, StorableClass}
...
class StringFieldValue(instance: StorableClass, @transient fieldInner: StringDatabaseField)(implicit persistenceSystem: PersistenceSystem) extends FieldValue[String](instance, fieldInner) {
	override def getPersistenceLiteral: (String, List[String]) = ("?", List(GetSQLLiteralForPrepared(super.get)))
